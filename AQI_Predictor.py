...
pressure = st.sidebar.slider("Pressure (MB)", 950.0, 1050.0,1010.0) 
wind =st.sidebar.slider("Wind Speed:", 0.0,  30.0, 5.0) 
...
# input the data 
input_data = np.array([[temp, humidity,pressure, wind, pm2_5, pm10, co, no2]]) 

...
if st.button("🔮 Predict AQI"): 
    ...
    if  0 < prediction <= 50: 
        ...
        "3. Control Traffic Emmisions \n  4. Public Awareness")  

    elif 200< prediction <= 300: 
        st.warning("Poor Air Quality 😷 \n The steps to be taken are: \n 1. Implement GRAP Stage 1 \n 2. Restrict diesel Generator\n " \
        " 3.Enforce Dust Control \n  4. Improve transportation and encourage electric vehicles")  

    else: 
        st.error("Severe Air Pollution ☠️ \n The steps to be taken are: \n 1. Ban unessential constructions \n 2. Vehicle Restrictions\n " \
        " 3.Industrial Restriction \n  4.Encourage Electric Vehicles \n  5. Medical Care to be given to Heart and Lung Patients")  
